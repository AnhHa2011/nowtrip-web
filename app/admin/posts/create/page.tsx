    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (!res.ok) {
                ...
                throw new Error(error.message || 'Lỗi tạo bài viết');
            }

            toast.success('Tạo bài viết thành công');
            router.push('/admin/posts');
        } catch (error) {
            toast.error(error instanceof Error ? error.message : 'Lỗi tạo bài viết');
            console.error(error);
        } finally {
            setSaving(false);
        }
    ...
    return (
        <div className="p-4 md:p-8 max-w-4xl mx-auto">
            <div className="mb-8">
                ...
                <h1 className="text-3xl md:text-4xl font-black text-gray-900">Tạo bài viết mới</h1>
            </div>
